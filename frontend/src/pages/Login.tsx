...
import { LogIn, AlertCircle, Eye, EyeOff, Car } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-bmw-text mb-2">Welcome Back</h2>
          <p className="text-gray-600">Sign in to your BMW account</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link to="/forgot-password" className="text-bmw-blue hover:text-bmw-blue-dark">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="text-bmw-blue hover:text-bmw-blue-dark font-medium">
                Create one now
              </Link>
            </p>
          </div>
